...
const QuizContainer = ({ questions, onResultsShow }: QuizContainerProps) => {
      ...
      gsap.to(cardRef.current, {
        ...
        onComplete: () => {
          if (currentQuestionIndex < questions.length - 1) {
            ...
            // Reset position immediately and animate in from left
            if (cardRef.current) {
  ...
  // Auto-advance after 2 seconds when question is answered
  useEffect(() => {
  ...
  // Reset card position when component mounts or question changes
  useEffect(() => {
      ...
      {!showResults ? (
        <>
          ...
          <div ref={cardRef} className="relative">
            <QuizCard
              key={currentQuestionIndex} // Force re-render when question changes
              question={questions[currentQuestionIndex]}
